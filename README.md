...
> **Sample on GitHub** · `AUDUSD_12h.csv` (85 rows, `2026-07-10` -> `2026-09-02`, 5.69 KB). **Full archive on [getdata.finance](https://getdata.finance/datasets/audusd)** — **14,119** `12h` rows (full `1m`: 5,263,593), **11 timeframes**, `2001-11-28` -> `2026-09-02`.
...
| 12h rows | 85 | **14,119** |
| Size | 5.69 KB | full ZIP on [getdata.finance](https://getdata.finance/datasets/audusd) |
